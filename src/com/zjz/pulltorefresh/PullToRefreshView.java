...
public class PullToRefreshView extends LinearLayout {
	...
	private void addFooterView() {
		...
		// getHeight()‰ªÄ‰πàÊó∂ÂÄô‰ºöËµãÂÄº,Á®çÂÄôÂÜçÁ†îÁ©∂‰∏Ä‰∏ã
		// Áî±‰∫éÊòØÁ∫øÊÄßÂ∏ÉÂ±ÄÂèØ‰ª•Áõ¥Êé•Ê∑ªÂä†,Âè™Ë¶ÅAdapterViewÁöÑÈ´òÂ∫¶ÊòØMATCH_PARENT,ÈÇ£‰πàfooter
		// viewÂ∞±‰ºöË¢´Ê∑ªÂä†Âà∞ÊúÄÂêé,Âπ∂ÈöêËóè
	 ...
	 * ÁöÑÂ
	 * ≠êViewÊù•Â§ÑÁêÜ;Âê¶ÂàôÁî±‰∏ãÈù¢ÁöÑÊñπÊ≥ïÊù•Â§ÑÁêÜ(Âç≥Áî±PullToRefreshViewËá
	 * ™Â∑±Êù•Â§ÑÁêÜ)
	 */
	@Override
	...
	private boolean isRefreshViewScroll(int deltaY) {
		...
		if (mAdapterView != null) {
			...
			if (deltaY > 0) {
				...
				if (child == null) {
					// Â¶ÇÊûúmAdapterView‰∏≠Ê≤°ÊúâÊï∞ÊçÆ,‰∏çÊã¶Êà™
					return false;
				}
				...
				if (mAdapterView.getFirstVisiblePosition() == 0
						&& Math.abs(top - padding) <= 8) {// ËøôÈáå‰πãÂâçÁî®3ÂèØ‰ª•Âà§Êñ≠,‰ΩÜÁé∞Âú®‰∏çË°å,ËøòÊ≤°ÊâæÂà∞ÂéüÂõ†
					mPullState = PULL_DOWN_STATE;
					return true;
				}
				...
				// Á≠â‰∫éÁà∂ViewÁöÑÈ´òÂ∫¶ËØ¥ÊòémAdapterViewÂ∑≤ÁªèÊªëÂä®Âà∞ÊúÄÂêé
	...
	/**
	 * header ÂáÜÂ§áÂà∑Êñ∞,ÊâãÊåáÁßªÂä®ËøáÁ®ã,ËøòÊ≤°ÊúâÈáäÊîæ
	 * 
	 * @param deltaY
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		// ÂΩìheader
		// viewÁöÑtopMargin>=0Êó∂ÔºåËØ¥ÊòéÂ∑≤ÁªèÂÆåÂÖ®ÊòæÁ§∫Âá∫Êù•‰∫Ü,‰øÆÊîπheader
		// view ÁöÑÊèêÁ§∫Áä∂ÊÄÅ
	...
	/**
	 * footer ÂáÜÂ§áÂà∑Êñ∞,ÊâãÊåáÁßªÂä®ËøáÁ®ã,ËøòÊ≤°ÊúâÈáäÊîæ ÁßªÂä®footer
	 * viewÈ´òÂ∫¶ÂêåÊ†∑ÂíåÁßªÂä®header view
	 * È´òÂ∫¶ÊòØ‰∏ÄÊ†∑ÔºåÈÉΩÊòØÈÄöËøá‰øÆÊîπheader
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		// footer ÁöÑÈ´òÂ∫¶
		// ËØ¥Êòéfooter view ÂÆåÂÖ®ÊòæÁ§∫Âá∫Êù•‰∫ÜÔºå‰øÆÊîπfooter view
		// ÁöÑÊèêÁ§∫Áä∂ÊÄÅ
	...
	private int changingHeaderViewTopMargin(int deltaY) {
		...
		// Ë°®Á§∫Â¶ÇÊûúÊòØÂú®‰∏äÊãâÂêé‰∏ÄÊÆµË∑ùÁ¶ª,ÁÑ∂ÂêéÁõ¥Êé•‰∏ãÊãâ
	 ...
	 * @description
	 * @param topMargin
	 *            Ôºå‰∏∫0Êó∂ÔºåËØ¥Êòéheader view ÂàöÂ•ΩÂÆåÂÖ®ÊòæÁ§∫Âá∫Êù•Ôºõ
